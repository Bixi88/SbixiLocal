...
const SbixiFolderAccess = (() => {
  ...
  async function readFileRaw(uri) {
    return await plugin().readFile({ uri });
  }
  ...
  return { pickFolder, listFolder, listPersistedFolders, releaseFolder, readAudioAsBlobUrl, readFileRaw };
})();
